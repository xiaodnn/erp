...
//        CreateFileUtil.generateFile(javapath,interfaceName,implateName);
    ...
    /**
     * 写Service文件内容.生成Service接口
     */
    public static void writerContent(String rootPath,String name) throws Exception{
        String path = "/com/erp/service/I"+name+"Service.java";
        BufferedReader br = null;
        BufferedWriter bw = null;
        try{
            String javapath = "/com/erp/dao/";//接口文件路径
...
//            String path_now = directory.getCanonicalPath(); //得到的是当前标准的路径
            ...
            e.printStackTrace();
            throw new Exception("写Service文件内容.生成Service接口异常:",e);
        }finally {
            try{
                if(bw != null){
                    bw.flush();
                ...
                bw = null;
                br = null;
                throw new Exception("写Service文件内容.生成Service接口关闭文件流时异常:",e);
            }
        }
    }
    ...
    public static void writerImplContent(String rootPath,String name) throws Exception{
        String javapath = "/com/erp/service/";//需要实现接口路径
...
//            String path_now = directory.getCanonicalPath(); //得到的是当前标准的路径
            ...
            e.printStackTrace();
            throw new Exception("写Service文件内容.实现Service接口关闭异常:",e);
        }finally {
            try{
                if(bw != null){
                    bw.flush();
                ...
                bw = null;
                br = null;
                throw new Exception("写Service文件内容.实现Service接口关闭文件流时异常:",e);
            }
        }
    }
